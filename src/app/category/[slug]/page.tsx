...
export default function CategoryPage({ params }: { params: { slug: string } }) {
  ...
  useEffect(() => {
    async function loadEvents() {
        setIsLoading(true);
        const events = await getCategoryEvents(categoryName);
  ...
  return <CategoryClientPage initialEvents={initialEvents} categoryName={categoryName} isLoading={isLoading} />;
}


function CategoryClientPage({ initialEvents, categoryName, isLoading }: { initialEvents: Event[], categoryName:string, isLoading: boolean}) {
