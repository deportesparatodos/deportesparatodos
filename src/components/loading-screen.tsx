    ...
    <div className="flex h-screen w-screen flex-col bg-background text-foreground p-4 overflow-hidden">
      ...
      <div className="flex flex-1 flex-col items-center justify-center overflow-hidden">
        <div className="w-full max-w-2xl text-center flex flex-col items-center">
            <div className="w-4/5 max-w-[200px] md:max-w-[300px] flex-shrink-0 mb-4 md:mb-8">
            <Image
            ...
            {/* Scrollable text container for very small screens */}
            <div className="space-y-4 md:space-y-6 overflow-y-auto px-1">
