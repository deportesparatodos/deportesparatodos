...
const channelsData: Channel[] = [
    ...
    { name: 'GolPeru (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/golperu.html', logoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQU5NdVG4od9akIwHShMdl92aQzAqGS_V95vA&s' },
    ...
    { name: 'ESPN Premium Argentina (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espnpremiumargentina.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/a1/ESPN_Premium_logo.svg' },
    { name: 'TyC Sports (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/tycsports.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/54/TyC_Sports_logo.svg' },
    ...
    { name: 'ESPN ARGENTINA (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espnar.html', logoUrl: 'https://a1.espncdn.com/combiner/i?img=%2Fi%2Fespn%2Fespn_logos%2Fespn_red.png' },
    ...
    { name: 'ESPN 2 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn2.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/ESPN2_logo.svg/1280px-ESPN2_logo.svg.png' },
    { name: 'ESPN 3 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn3.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/51/ESPN3_Logo.png' },
    { name: 'ESPN 4 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn4.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/ESPN_4_logo.svg/2560px-ESPN_4_logo.svg.png' },
    { name: 'ESPN 5 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn5.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/ESPN_5_logo.svg/2560px-ESPN_5_logo.svg.png' },
    { name: 'ESPN 6 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn6.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/ESPN_6_logo.svg/2560px-ESPN_6_logo.svg.png' },
    { name: 'ESPN 7 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn7.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/ESPN_7_logo.svg/1280px-ESPN_7_logo.svg.png' },
    { name: 'Dsports (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/directvsports.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/5a/DSports.png' },
    { name: 'Dsports 2 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/directvsports2.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/8/83/DSports2.png' },
    { name: 'Dsports + (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/directvsportsplus.html', logoUrl: 'https://d18o29lhcg4kda.cloudfront.net/fit-in/360x270/Y2gwMTAwMDAwMDAwMTM5X2xpbmVhcl9jaGFubmVsX3NzbGE_11002_LOGO_360x270.png?timestamp=1750317237946' },
    { name: 'Fox Sports 1 MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/foxsportsmexico.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/FOX_Sports_logo.svg/1200px-FOX_Sports_logo.svg.png' },
    { name: 'Fox Sports 2 MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/foxsports2mexico.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Fox_Sports_2_Argentina_2023.svg/1200px-Fox_Sports_2_Argentina_2023.svg.png' },
    { name: 'Fox Sports 3 MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/foxsports3mexico.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Fox_Sports_3_Argentina_2023.svg/800px-Fox_Sports_3_Argentina_2023.svg.png' },
    { name: 'ESPN MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espnmexico.html', logoUrl: 'https://r2.thesportsdb.com/images/media/channel/logo/fysmne1660760631.png' },
    { name: 'ESPN 2 MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn2mexico.html', logoUrl: 'https://r2.thesportsdb.com/images/media/channel/logo/f6gq9s1660760610.png' },
    { name: 'ESPN 3 MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/espn3mexico.html', logoUrl: 'https://img2.sport-tv-guide.live/images/tv-station-espn-3-939.png' },
    ...
    { name: 'TVC Deportes MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/tvcdeportes.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/1a/Tvc_2003.png' },
    { name: 'LIGA 1', url: 'https://embed.ksdjugfsddeports.fun/embed/liga1.html', logoUrl: 'https://placehold.co/24x24.png' },
    { name: 'Liga 1 MAX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/liga1max.html', logoUrl: 'https://play-lh.googleusercontent.com/utRBgwflE7hqjt4UvWeNO_AA1MHdP4l9dVD1V38DdRM9GGzxD5xK1iyXRPcnOXV9d6M' },
    { name: 'Fox Sports Premium (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/foxsportspremium.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/cf/Fox_Sports_Premium_Argentina_2020.png' },
    { name: 'MOVISTAR DEPORTES PE', url: 'https://embed.ksdjugfsddeports.fun/embed/movistardeportes.html', logoUrl: 'https://placehold.co/24x24.png' },
    { name: 'DAZN F1 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/daznf1.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/70/DAZN_F1_logo.png' },
    { name: 'DAZN LaLiga (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/daznlaliga.html', logoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDZqHtFwkPR8CyxP8MPc2_El0YqtCFF4zzng&s' },
    { name: 'Movistar Liga de Campeones (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/movistarligadecampeones.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Movistar_Liga_de_Campeones.svg/2560px-Movistar_Liga_de_Campeones.svg.png' },
    { name: 'Win Sports (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/winsports.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Win_Sports_nuevo_logo.svg/1200px-Win_Sports_nuevo_logo.svg.png' },
    { name: 'Win Sports + (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/winsportsplus.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Win_Sports_nuevo_logo.svg/1200px-Win_Sports_nuevo_logo.svg.png' },
    ...
    { name: 'Azteca Deportes MX (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/aztecadeportes.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Aztecadeporteslogo.png/500px-Aztecadeporteslogo.png' },
    { name: 'TNT Sports Chile (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/tntsportschile.html', logoUrl: 'https://yt3.googleusercontent.com/nv5OCOIRHGSuTpTqhUrSJlfgZkBxicFbTY_8uXsjLMNrsZ7-TmJSFIvBJdhpxRTOky9kDvRuXJU=s900-c-k-c0x00ffffff-no-rj' },
    ...
    { name: 'AZTECA 7 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/azteca7.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Logo_Azteca_7_2011.svg/1930px-Logo_Azteca_7_2011.svg.png' },
    { name: 'CANAL 5 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/canal5.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/1d/Canal_5_Mexico_logo_2014.svg' },
    ...
    { name: 'TNT (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/tnt.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/24/TNT_Logo_2016.svg' },
    ...
    { name: 'Telefe (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/telefe.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/cc/Telefe_%28nuevo_logo%29.png' },
    ...
    { name: 'History (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/history.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/The_History_Channel_logo.png/250px-The_History_Channel_logo.png' },
    { name: 'History 2 (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/history2.html', logoUrl: 'https://cdn.mitvstatic.com/channels/ar_h2_m.png' },
    ...
    { name: 'Caracol (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/caracol.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/65/Logotipo_de_Caracol_Televisi%C3%B3n_Corporativo.png' },
    { name: 'ATV (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/atv.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/ATV_logo_2020.png' },
    { name: 'Univision (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/univision.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/af/Logo_Univision_2019.svg' },
    ...
    { name: 'GOLDEN EDGE', url: 'https://embed.ksdjugfsddeports.fun/embed/goldenedge.html', logoUrl: 'https://placehold.co/24x24.png' },
    ...
    { name: 'MTV (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/mtv.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/MTV_2021_%28brand_version%29.svg/1200px-MTV_2021_%28brand_version%29.svg.png' },
    { name: 'Comedy Central (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/comedycentral.html', logoUrl: 'https://1000marcas.net/wp-content/uploads/2022/01/Comedy-Central-Productions-Logo.png' },
    { name: 'Nat Geo (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/natgeo.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/22/Nat_Geo_HD.png' },
    { name: 'Animal Planet (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/animalplanet.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/20/2018_Animal_Planet_logo.svg' },
    ...
    { name: 'RCN', url: 'https://embed.ksdjugfsddeports.fun/embed/rcn.html', logoUrl: 'https://placehold.co/24x24.png' },
    ...
    { name: 'TV Pública (Op. 2)', url: 'https://embed.ksdjugfsddeports.fun/embed/tvpublica.html', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/TVP_-_Televisi%C3%B3n_P%C3%BAblica_%282021%29.svg/1200px-TVP_-_Televisi%C3%B3n_P%C3%BAblica_%282021%29.svg.png' },
