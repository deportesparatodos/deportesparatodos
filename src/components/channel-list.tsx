...
const channelsData: Channel[] = [
    ...
    { name: 'Eleven Sports 4 PT', url: 'https://streamtpglobal.com/global1.php?stream=eleven4_pt', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/c/c8/Eleven_Sports_4.svg/revision/latest/scale-to-width-down/300?cb=20210210163056' },
    { name: 'Eleven Sports 5 PT', url: 'https://streamtpglobal.com/global1.php?stream=eleven5_pt', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/9/93/Eleven_Sports_5.svg/revision/latest/scale-to-width-down/300?cb=20210210163233' },
    ...
    { name: 'GolPeru', url: 'https://streamtpglobal.com/global1.php?stream=golperu', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/c/cb/Gol_Per%C3%BA_2016.svg/revision/latest/scale-to-width-down/1200?cb=20240224034010&path-prefix=es' },
    ...
    { name: 'HI! Sports MX', url: 'https://streamtpglobal.com/global1.php?stream=hisports', logoUrl: 'https://static.wikia.nocookie.net/liga-mx/images/3/30/HISportslogo.png/revision/latest?cb=20230427055859&path-prefix=es' },
    ...
    { name: 'History 2', url: 'https://tvlibreonline.org/html/fl/?get=SGlzdG9yeV8y', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/7/78/H2.png/revision/latest?cb=20190701021604&path-prefix=es' },
    ...
    { name: 'Liga 1 MAX', url: 'https://streamtpglobal.com/global1.php?stream=liga1max', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/f/f2/Liga1Max.png/revision/latest?cb=20230808222009&path-prefix=es' },
    ...
    { name: 'Win Play +', url: 'https://streamtpglobal.com/global1.php?stream=winplusonline1', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/7/79/WinPlay2024.svg/revision/latest/scale-to-width-down/320?cb=20240716031837&path-prefix=es' },
    { name: 'Win Sports', url: 'https://streamtpglobal.com/global1.php?stream=winsports', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/7/79/WinPlay2024.svg/revision/latest/scale-to-width-down/320?cb=20240716031837&path-prefix=es' },
    { name: 'Win Sports +', url: 'https://streamtpglobal.com/global1.php?stream=winplus', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/7/79/WinPlay2024.svg/revision/latest/scale-to-width-down/320?cb=20240716031837&path-prefix=es' },
    { name: 'Win Sports + (Op2)', url: 'https://streamtpglobal.com/global1.php?stream=winplus2', logoUrl: 'https://static.wikia.nocookie.net/logopedia/images/7/79/WinPlay2024.svg/revision/latest/scale-to-width-down/320?cb=20240716031837&path-prefix=es' },
];
